...
namespace Cometa.Persistence.Migrations
{
    ...
    [Migration("20240901213533_MoreEnumsAndGUIDrelations")]
    partial class MoreEnumsAndGUIDrelations
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Cometa.Persistence.Model.Todo", b =>
                {
                    ...
                    b.HasIndex("SkillsId")
                        .HasDatabaseName("ix_todos_skills_id");
            ...
            modelBuilder.Entity("Cometa.Persistence.Model.Todo", b =>
                {
                    ...
                    b.HasOne("Cometa.Persistence.Model.Skill", "Skills")
                        .WithMany()
                        .HasForeignKey("SkillsId")
                        .HasConstraintName("fk_todos_skill_skills_id");
