...
namespace Cometa.Persistence.Migrations
{
    ...
    [Migration("20250410144510_AddOrganizationsWithNullableForeignKey")]
    partial class AddOrganizationsWithNullableForeignKey
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Cometa.Persistence.Model.Organization", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Cometa.Persistence.Model.OrganizationMember", b =>
                {
            ...
            modelBuilder.Entity("Cometa.Persistence.Model.Organization", b =>
                {
                    b.HasOne("Cometa.Persistence.Model.ApplicationUser", "Owner")
                        .WithMany()
            ...
            modelBuilder.Entity("Cometa.Persistence.Model.OrganizationMember", b =>
                {
                    b.HasOne("Cometa.Persistence.Model.Organization", "Organization")
                        .WithMany("Members")
                        .HasForeignKey("OrganizationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Cometa.Persistence.Model.ApplicationUser", "User")
